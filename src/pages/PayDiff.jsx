...
import { Hexagon, Construction, LogOut, Lock } from 'lucide-react';
...
export default function PayDiff() {
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans p-8 relative">
      <div className="absolute top-0 left-0 w-full h-96 bg-gradient-to-b from-orange-500/5 to-transparent -z-10 pointer-events-none" />
      <div className="max-w-6xl mx-auto">
        
        {/* Header - Standalone */}
        <div className="flex justify-between items-center mb-12 border-b border-white/10 pb-6">
          <div className="flex items-center gap-4">
            <div className="w-12 h-12 rounded-xl liquid-glass flex items-center justify-center border border-orange-500/30 shadow-[0_0_20px_rgba(249,115,22,0.2)]">
              <Hexagon className="text-orange-400" size={24} />
            </div>
            <div>
              <h1 className="text-2xl font-bold">Nexus PayDiff</h1>
              <p className="text-gray-400 text-sm">Instant Payroll Variance Analysis</p>
            </div>
          </div>
          <div className="flex items-center gap-4">
            <div className="hidden md:flex items-center gap-2 text-orange-400 text-sm bg-orange-500/10 px-4 py-2 rounded-full border border-orange-500/20">
              <Lock size={14} />
